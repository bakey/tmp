...
$this->widget('ext.EAjaxUpload.EAjaxUpload',
		array(
				'id'=>'uploadFile',
				'config'=>array(
						'action'=>Yii::app()->createUrl('/teach/knowledgepoint/doimportknowledgepoint' . "&course_id=" . $course ),
						'allowedExtensions'=>array("xls","xlsx"),
						'sizeLimit'=>10*1024*1024,// maximum file size in bytes
						'onComplete'=>"js:function(id, fileName, responseJSON){
										$.post('".Yii::app()->createUrl('teach/knowledgepoint/loadknowledgepoint&course_id='.$course )."&fname='+responseJSON.filename, { fname:responseJSON.filename }, function(data){
																$('#loadkpinfo').html(data);
...
<?php echo CHtml::ajaxButton ("确认导入知识点信息",
                              CController::createUrl('/teach/knowledgepoint/writeknowledgepointdata' . "&course_id=".$course), 
