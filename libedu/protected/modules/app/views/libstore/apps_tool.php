 ...
 <a href="index.php?r=teach/edition/admin" onclick="" rel="external">
            <div class="carton col_4 app_carton">
              ...
              <div class="content current courseitemcontent">
              		<span class="">课件制作应用</span>
              		<HR align=left width=318 color=#990099 SIZE=1 noShade>
              		<div style="height:70px">
              			<div style="">
              				课件制作应用能够帮助老师解决课件制作的问题，让老师更便捷地制作教学课件
              			</div>
              		</div>
              		<HR align=left width=318 color=#990099 SIZE=1 noShade>   
            ...
            <div class="carton col_4 app_carton">
              ...
              <div class="content current courseitemcontent">
              		...
              		<HR align=left width=318 color=#990099 SIZE=1 noShade>
              			...
              			<div style="height:70px">
              			<div style="">
              				云笔记是一款专注于简单高效的个人记事工具！简单易用,极速上手。云端同步功能，可现实网页、iPhone、Android客户端之间的信息同步，随时随地查阅和编辑
              			</div>
              		</div>
              		<HR align=left width=318 color=#990099 SIZE=1 noShade>   
              		<span class="col_4">使用人数 889</span>
